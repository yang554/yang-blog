        ...
        <el-col :xs="12" :sm="12" :lg="8" class="card-panel-col">
            <div class="card-panel">
                <div class="card-panel-description">
                    ...
                    <count-to :start-val="0" :end-val="legalWifeCount" :duration="3000" class="card-panel-num" />
                </div>
            </div>
        </el-col>
        <el-col :xs="12" :sm="12" :lg="8" class="card-panel-col">
            <div class="card-panel">
                <div class="card-panel-description">
                    ...
                    <count-to :start-val="0" :end-val="maxAge" :duration="3200" class="card-panel-num" />
                </div>
            </div>
        </el-col>
    </el-row>
...
import { _getSourceCount ,_getSourceCountByDX} from "@/api/api.js";
...
export default {
    ...
    methods: {
        init() {
            _getSourceCount().then(res => {
                if (res.data.status === 200) {
                    this.userCount = res.data.obj;
                }
            })

            _getSourceCountByDX().then(res => {
                if (res.data.status === 200) {
                    this.legalWifeCount = res.data.obj;
                }
            })
        }
    },
