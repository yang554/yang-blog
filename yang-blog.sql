...
CREATE TABLE `sys_role`  (
  ...
  `name_zh` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '中文名',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `sys_user`  (
  ...
  `avatar` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NULL DEFAULT NULL COMMENT '头像',
  `email` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NULL DEFAULT NULL COMMENT '邮箱',
  `phone` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NULL DEFAULT NULL COMMENT '电话',
  `address` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NULL DEFAULT NULL COMMENT '地址',
  `description` varchar(512) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NULL DEFAULT NULL COMMENT '用户描述',
  `salt` varchar(256) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NULL DEFAULT NULL COMMENT '密码加',
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  `note` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NULL DEFAULT NULL COMMENT '备注',
  `etx01` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NULL DEFAULT NULL COMMENT '备用字段',
  `etx02` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NULL DEFAULT NULL COMMENT '备用字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1706696930266 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_unicode_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_user` VALUES (1700732037690, '柳莉莉', '75257cfbddff8c1dc73b2a16ee7d26ea', '匿名', '/static/2024-02-07/温迪2.jpg', 'undefined@qq.com', '15723084621', NULL, '', '2nd13j', '2023-11-23 17:33:58', '2024-02-07 16:16:17', NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (1706696930264, '1001', 'fcb8ce784bfe7cefb38a21e99649525e', NULL, '/static/2024-03-10/defaultW.png', NULL, '15723084621', NULL, NULL, 'kcut0d', '2024-02-07 16:00:42', '2024-03-10 19:07:24', NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (1706696930265, '1002', '4662d5c8e34c6b6eddc71e91e3b4ab4d', NULL, '/static/2024-03-10/defaultImg.png', NULL, '15723084621', NULL, NULL, 'ya0aqq', '2024-02-07 16:11:32', '2024-03-10 19:07:07', NULL, NULL, NULL);
...
CREATE TABLE `sys_user_role`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1707293492902 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_user_role` VALUES (1706696930356, 1706696930263, 4);
INSERT INTO `sys_user_role` VALUES (1707292842194, 1706696930264, 4);
INSERT INTO `sys_user_role` VALUES (1707293492901, 1706696930265, 4);
...
INSERT INTO `u_aunt` VALUES (1707271345913, '柳莉莉', '2024-02-05', '2024-02-10', '28天', '5天', '36', '', '5号傍晚来的，10号下午走的', '0');
INSERT INTO `u_aunt` VALUES (1709600276025, '柳莉莉', '2024-03-05', '2024-03-11', '28天', '6天', '48', '吃了点辣椒，着了点凉', '5号6点20来的\n11号早上走', '0');
...
INSERT INTO `u_even` VALUES (1710744381036, '南京周末聚', '15号请假两小时，从福州南出发，到达南京南，然后南京站汇合，再根据第二天出行决定住宿问题', '2024-03-15 16:00:00', '2024-03-17 16:00:00', '杨华杰', '福州出发，目的南京南', '普通', '0', '2024-03-18 14:41:07', '1680851452956', '本次出行\n路费：930.5\n吃喝：505.3\n玩：130\n总计：1565.8');
...
CREATE TABLE `u_source`  (
  `S_ID` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '主键',
  `S_NAME` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '姓名',
  `S_PIN_YIN` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '姓名拼音',
  `S_BIRTHDAY` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '生日',
  `S_SEX` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '性别',
  `S_ADDRESS_NEW` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '现住地址',
  `S_ADDRESS_OLD` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '户口地址',
  `S_PHONE` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '电话',
  `S_EMIL` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '邮箱',
  `S_LOVE` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '第几代',
  `S_FID` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '父ID',
  `S_MID` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '母ID',
  `S_IMG_URL` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '头像',
  `S_IS_SURVIVAL` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '1' COMMENT '是否存活（‘1’为存活，‘0’为死亡）',
  `S_DIE_DAY` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '死亡日期',
  `S_MATE_ID` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '配偶ID',
  `S_NOTE` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '座右铭',
...
INSERT INTO `u_source` VALUES ('a05zuimvb1', '秦光芳', 'qinguangfang', '1941-03-23', '女', '重庆市丰都县龙孔镇', '重庆市丰都县龙孔镇', '15723084621', '', '2', NULL, NULL, '/static/2024-02-07/yl.jpg', '1', '', '7hdj73e2m3', '零零');
